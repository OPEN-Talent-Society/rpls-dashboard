# Universal Research Framework Quick Reference

**Comprehensive Multi-Agent Research and Analysis Framework**

*(formerly Universal Search Algorithm for Claude Flow - USACF)*

## What Is the Universal Research Framework?
...
**Framework Location:** `.claude/agents/specialized/universal-research-framework.md`
...
Task {
  ...
  description: "Universal Research Framework analysis",
  prompt: "Follow universal-research-framework.md to analyze X market. Apply step-back prompting, multi-agent decomposition, and RAG integration for comprehensive analysis."
}
```
...
## Universal Research Framework Workflow Example
...
Task {
  ...
  prompt: "Research X market in 2025. Use Universal Research Framework: web search, data collection, trend analysis. Store findings in memory."
}
...
Task {
  ...
  prompt: "Identify quality, performance, capability, and strategic gaps in X market using Universal Research Framework dimensional analysis."
}
...
## Universal Research Framework Techniques (20+)
...
Universal Research Framework is **Level 4** in the Research SOP:

```
Level 1: Memory (Qdrant, AgentDB) - < 1 sec
Level 2: Docs (Context7) - < 5 sec
Level 3: Web (WebFetch/WebSearch) - < 10 sec
Level 4: Universal Research Framework - minutes (use research agents)
```
...
**Always store Universal Research Framework findings:**

```javascript
mcp__claude-flow__agentdb_pattern_store({
  sessionId: "research-framework-analysis",
  task: "Universal Research Framework market analysis for X",
  input: "Market research query with Universal Research Framework",
  ...
  critique: "Universal Research Framework analysis was comprehensive. Found 12 gaps, generated 8 opportunities. Adversarial review identified 2 assumptions to validate. Next: validate customer demand."
})
```

## Performance Metrics

**Typical Universal Research Framework Analysis:**
...
```bash
# Execute research with Universal Research Framework
/research "topic" --deep

# Search memory for previous framework analyses
/memory:memory-search "Universal Research Framework market analysis"

# Check research framework agent availability
...
|----------|-------------|
| `.claude/agents/specialized/universal-research-framework.md` | Full framework documentation |
...
**Remember:** Universal Research Framework is for complex, high-value analysis requiring depth, validation, and strategic synthesis. For simpler queries, use Research SOP Levels 1-3 first.
