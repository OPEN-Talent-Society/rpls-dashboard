...
# DigitalOcean Operations Guide
 ...
 Related playbooks: DevOps Operations Guide[^1], Docker Host Operations Guide[^2], Network Engineering Playbook[^18], Docmost & NocoDB Backup SOP[^3].
...
[^1]: # devops-operations
    ...
    # DevOps Operations Guide
     ...
     Related playbooks: [DigitalOcean Operations Guide](#20251103060428-na196uh), Docker Host Operations Guide[^2], Cortex (SiYuan) Operations Agent[^8], Docmost &amp; NocoDB Migration Programme[^6].
...
[^2]: # docker-host-operations
    ...
    > Related: DevOps Operations Guide[^1], Docmost &amp; NocoDB Backup SOP[^3], Migration Activity Log[^4], Docmost &amp; NocoDB Migration Programme[^6].
    >
