...
- `PUBLIC_SUPABASE_ANON_KEY` - Anon key (for client operations)

The helper script automatically loads these from `/Users/adamkovacs/Documents/codebuild/.env`
...
# Get all rows from patterns table
supabase_get "/rest/v1/patterns?select=*"

# Get all rows from learnings table
supabase_get "/rest/v1/learnings?select=*"
```
